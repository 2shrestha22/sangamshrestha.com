...
const siteConfig: SiteConfig = {
    ...
    hero: {
        title: 'Hi  👋',
        text: 'I am a Flutter developer with 5+ years of experience building high-performance apps. I also contribute to open-source projects, mentor developers, and work on ClashLy. 🚀',
        image: {
            src: '/sangam512.jpg',
